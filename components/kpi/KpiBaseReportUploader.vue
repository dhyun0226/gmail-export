<template>
  ...
  >
    ...
    <div v-else class="flex items-start justify-between gap-3 bg-white p-3 rounded-lg shadow-sm border border-green-100">
      <div class="flex items-start gap-3 min-w-0 flex-1">
        ...
        <div class="text-left min-w-0 flex-1">
          <p class="text-sm font-semibold text-gray-900 break-all leading-5">{{ uploadedFile.name }}</p>
